...
#p2.setBgImage('img/bgimage.jpg')           ## Optional, set chart background image
...
p2.fileToSave('result/02_scatter-2.svg')    ## Optional, file to save current chart
p2.Plot(*data)
...
#p4.setBgImage('img/bgimage.jpg')           ## Optional, set chart background image
...
p4.fileToSave('result/04_bar.svg')          ## Optional, file to save current chart
p4.Plot(*data)
...
#p6.setBgImage('img/bgimage.jpg')           ## Optional, set chart background image
...
p6.fileToSave('result/06_bar.svg')          ## Optional, file to save current chart
p6.Plot(*data)
...
#p8.setBgImage('img/bgimage.jpg')           ## Optional, set chart background image
data = []
data.append(p8.PieData(ag, 'Dataset A'))
data.append(p8.PieData(bg, 'Dataset B (filtered)', minpercent = 8))
p8.fileToSave('result/08_pie.svg')          ## Optional, file to save current chart
p8.Plot(*data)
...
prepared_map, width, height, corner_points = CDH.map_prepare(f"img/rectangular_map.jpg") ## rectangular map image used as background image
...
data.append(p10.ScatterData(ac, 'Route A track', 'r'))
data.append(p10.ScatterData(bc, 'Route B track', 'b'))
p11.fileToSave('result/11_rectangular_map.svg')
p11.Plot(*data)
